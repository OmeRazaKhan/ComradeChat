...
def main():
    ...
    print(search("Give me all the datasets that correspond to cars, planes, and boats")) # this is the user's query. it will return an array of ids. This will be called everytime the user types something in.
